...
public class prostitution_buy extends Activity {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                " where "+"Category=?  AND "+"Sub_Category_name=? AND "+"Law_number=?"
                ,new String []{"FemaleProtectionAct","Prostititution","371B"});
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(prostitution_buy.this, prostitution.class);
