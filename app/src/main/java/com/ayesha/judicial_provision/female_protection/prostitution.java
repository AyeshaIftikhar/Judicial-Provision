package com.ayesha.judicial_provision.female_protection;
...
import com.ayesha.judicial_provision.Laws.FemaleProtectionCategories;
...
public class prostitution extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                " where "+"Category=?  AND "+"Sub_Category_name=?",new String []{"FemaleProtectionAct","Prostititution"});
        ...
        listAdapter = new SqLiteLawsAdapter(prostitution.this,NumberList, NameList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(prostitution.this,
                        NameList.get(position).trim(), Toast.LENGTH_LONG).show();

                switch(NumberList.get(position)){
                    case "371A":
                        Intent intent=new Intent(prostitution.this,prostitution_sell.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        break;
                    case "371B":
                        Intent intent1=new Intent(prostitution.this,prostitution_buy.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(prostitution.this, FemaleProtectionCategories.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        super.onBackPressed();
    }
