...
public class prostitution_sell extends Activity {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                ...
                ,new String []{"FemaleProtectionAct","Prostititution","371A"});
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(prostitution_sell.this, prostitution.class);
