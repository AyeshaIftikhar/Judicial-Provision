...
public class offences extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                " where "+"Category=?  AND "+"Sub_Category_name=?",new String []{"CivilLaws","Offences"});
        ...
        listAdapter = new SqLiteLawsAdapter(offences.this,NumberList, NameList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(offences.this,
                        NameList.get(position).trim(), Toast.LENGTH_LONG).show();

                Intent intent = new Intent(offences.this, offence_frag.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(offences.this, CivilLawsCategories.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        super.onBackPressed();
    }
