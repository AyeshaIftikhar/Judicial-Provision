...
public class speech extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                " where "+"Category=?  AND "+"Sub_Category_name=?",new String []{"Cyber","Speech"});
        ...
        listAdapter = new SqLiteLawsAdapter(speech.this,NumberList, NameList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(speech.this, speech_frag.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(speech.this, CyberLawsCategories.class);
