...
public class Access_Info extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void showLaws() {
        ...
        listAdapter = new SqLiteLawsAdapter(Access_Info.this,NumberList, NameList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Access_Info.this,
                        NameList.get(position).trim(), Toast.LENGTH_LONG).show();

                Intent intent = new Intent(Access_Info.this, access_info_frag.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(Access_Info.this, CyberLawsCategories.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        super.onBackPressed();
    }
