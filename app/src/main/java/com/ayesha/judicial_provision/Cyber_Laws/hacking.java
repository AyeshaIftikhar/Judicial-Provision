...
public class hacking extends Activity implements SearchView.OnQueryTextListener {
    ...
    private void showLaws() {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM Laws_Table" +
                " where "+"Category=?  AND "+"Sub_Category_name=?",new String []{"Cyber","Hacking"});
        ...
        listAdapter = new SqLiteLawsAdapter(hacking.this,NumberList, NameList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(hacking.this,
                        NameList.get(position).trim(), Toast.LENGTH_LONG).show();

                Intent intent = new Intent(hacking.this, hacking_frag.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(hacking.this, CyberLawsCategories.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        super.onBackPressed();
    }
